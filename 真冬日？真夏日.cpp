...
int main()
{
    ...
    rep(n)
    {
        ...
        if (maxi[i] >= 35)
        {
            mp["Extremely Hot Day"]++;
        }
        if (30 <= maxi[i] && maxi[i] < 35)
        {
            mp["Midsummer Day"]++;
        }
        if (25 <= maxi[i] && maxi[i] < 30)
        {
            mp["Summer Day"]++;
        }
        if (mini[i] >= 25)
    ...
    vll ans = {mp["Extremely Hot Day"] ,  mp["Midsummer Day"], mp["Summer Day"], mp["Tropical Night"], mp["Winter Day"], mp["Midwinter Day"]};
    out(ans);
