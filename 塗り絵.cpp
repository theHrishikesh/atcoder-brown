...
int main()
{
    ...
    bool circle_inside_rectangle = true;
    if (!(x2 <= x1 - r)) circle_inside_rectangle = false;
    if (!(x1 + r <= x3)) circle_inside_rectangle = false;
    if (!(y2 <= y1 - r)) circle_inside_rectangle = false;
    if (!(y1 + r <= y3)) circle_inside_rectangle = false;
    ...
    // Output
    if (circle_inside_rectangle) cout << "NO\n";
    else cout << "YES\n";

    if (rectangle_inside_circle) cout << "NO\n";
    else cout << "YES\n";
}
